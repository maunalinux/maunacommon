...
Gtk.IconTheme.get_default().append_search_path("/usr/share/mauna/icons")
...
class Installer(GObject.Object):
    ...
    def __init__(self, pkg_type=PKG_TYPE_ALL, temp=False):
        ...
        if temp:
            f = tempfile.NamedTemporaryFile(prefix="mauna-common-installer-tmp")
    ...
    def _get_flatpak_status(self):
        try:
            ...
            warn("No flatpak support, install flatpak and gir1.2-flatpak-1.0 and restart maunainstall to enable it.")
